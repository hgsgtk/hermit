...
![](https://github.com/hgsgtk/hermit/raw/master/images/screenshot.png)
...
![](https://github.com/hgsgtk/hermit/raw/master/images/hermit.png)
...
```bash
$ git clone https://github.com/hgsgtk/hermit.git themes/hermit
```
...
```bash
$ git submodule add https://github.com/hgsgtk/hermit.git themes/hermit
```
